...
use Carbon\Carbon;
class onGoingServices extends Controller
{
    /**
    ...
    */
    ...
    public function index(){
        ...
        $firstSectionContents   = DB::table('postWithImage')->select('*')->where('menuId',$id)->get();
        ...
        $servicePageEditorArr   = array(
          ...
          'sectionOneContents'    => $firstSectionContents,
          'subMenus'              => $subMenus,
          'id'                    => $id,
          'menus'                 => $menus

      );
        return view('security.onGoingServices' , $servicePageEditorArr);

        // return view('security.onGoingServices');
    }
