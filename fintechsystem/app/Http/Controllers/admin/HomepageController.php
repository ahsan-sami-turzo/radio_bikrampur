...
class HomepageController extends Controller
{
    ...
    */
    ...
    {   $subMenus   = DB::table('submenu')->select('*')->get();
        ...
        return view('security.admin.homePageEditor.adminHomePageEditor',['data' => $data,'sliders' => $sliders,'photoGalleries' => $photoGalleries,'galleryName' => $galleryName,'subMenus' => $subMenus,'factsArea' => $factsArea]);
    }
