...
<body>
	<!-- start banner Area -->
	@if($aboutBackGrounds)
	<section class="banner-area relative" id="home" style="background:url('{{asset('public/uploads/images/backgroundImages')}}/{{$aboutBackGrounds->backGroundImagePath}}');background-size:cover; ">
