...
@section('main-page')
<div class="subHeader">
  <h1 style="color:#3c7376;font-family: 'Monoton', cursive;">EDIT  ABOUT</h1>
</div>
<div class="panel panel-info ">
  <div class="panel-body">
    ...
    <div class="row" style="">
       ...
       {{--
              Adding Images From BackGround.
              Here Background Image from : about database
              --}}
              ...
              <div class="col-sm-4 col-md-2" style="padding-top:10px;background:#3a768685;">
               <div class="thumbnail">
                 <img src="{{asset('public/uploads/images/backgroundImages/')}}/{{$aboutBackGround->backGroundImagePath}}" alt="5Terre" >
                 <div class="caption">
                   <h3></h3>
               ...
               <div class="form-group"  >
                 <div class="col-md-3">
                   <label>Select image to upload:<label><br>
                    <input type="file" name="firstSectionImage" id="firstSectionImageId" required>
                  </div>
                </div>
              </div>
        ...
        console.log(data);
            ...
            $("#firstSectionContents").submit(function(event) {
              ...
              $.ajax({
                type: 'get',
                // url: './adminAboutPageEditor'
                url: './commonPageEditorAdd',
                data: formData,
