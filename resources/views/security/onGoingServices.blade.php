...
<body>
	...
	@if($aboutBackGrounds)
	<section class="banner-area relative" id="home" style="background:url('{{asset('public/uploads/images/backgroundImages/'.$aboutBackGrounds[0]->image)}}');background-size:cover; ">
